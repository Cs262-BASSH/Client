...
/**Display items in laptop category */
export default function LampComs({ route, navigation }) {
    ...
    const getItems = async () => {
        try {
            const response = await fetch("https://quiet-oasis-96937.herokuapp.com/useritem/category/5");
