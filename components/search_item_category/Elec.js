...
/**Display items in Electronics category */
export default function Electronics({ route, navigation }) {
    ...
    const getItems = async () => {
        try {
            const response = await fetch("https://quiet-oasis-96937.herokuapp.com/useritem/category/4");
