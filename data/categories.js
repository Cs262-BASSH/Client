/*
  Data object for categories. When user goes to the search tab
  and choses a category, inputs only the selected category items.
...
export default items = [
  {
      name: "Fellowship of the Ring", price: 8.8,
      description: "Some hobbits begin a quest."
  },
  {
      name: "Two Towers", price: 8.7, 
      description: 'Some dark lords try to take over the world.'
  },
  {
      name: "Return of the King", price: 8.9, 
